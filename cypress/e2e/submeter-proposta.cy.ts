  ...
  context('Edição Proposta', () => {
    ...
    context.only('Abrangência', () => {
        ...
        context('Caminho Feliz', () => {
            ...
            it.only('deve adicionar Abrangência informando apenas o Estado sem Município', () => {
                cy.get('@fixture').then(({ propostaValida }: any) => {
                    cy.get('[data-cy="add-button"]').click();
                    cy.selecionarOpcao('open-estado-id', 'search-estado-id', propostaValida.caracterizacao.abrangencia.estado);
                    cy.get('[data-cy="abrangencia-confirmar"]').click();
        ...
        context('Editar', () => {
            it.only('deve editar os Municípios de uma Abrangência já adicionada com sucesso', () => {
                cy.get('@fixture').then(({ propostaValida }: any) => {
                cy.get('[data-cy="add-button"]').click()
                cy.selecionarOpcao('open-estado-id', 'search-estado-id', propostaValida.caracterizacao.abrangencia.estado)
                cy.selecionarOpcao('open-municipio-execucao-evento', 'search-municipio-execucao-evento', propostaValida.caracterizacao.abrangencia.municipios[0])
                cy.get('[data-cy="abrangencia-confirmar"]').click()
                cy.contains('tr', propostaValida.caracterizacao.abrangencia.estado)
                    .find('button[aria-label="editar"]') // REPORT: sem data-cy por linha
                    .click()
                cy.get('[data-cy="search-municipio-execucao-evento"]').clear()
                cy.selecionarOpcao('open-municipio-execucao-evento', 'search-municipio-execucao-evento', propostaValida.caracterizacao.abrangencia.municipioEdicao)
                cy.get('[data-cy="abrangencia-confirmar"]').click()
                cy.contains('td', propostaValida.caracterizacao.abrangencia.municipioEdicao).should('be.visible')
                cy.contains('td', propostaValida.caracterizacao.abrangencia.municipios[0]).should('not.exist')
                })
            })
        })
        ...
        context('Excluir', () => {
            it('deve excluir uma Abrangência já adicionada com sucesso', () => {
                ...
                cy.get('[data-cy="abrangencia-confirmar"]').click()
                cy.contains('tr', propostaValida.caracterizacao.abrangencia.estado)
                    .find('button[aria-label="excluir"]') // REPORT: sem data-cy por linha
                    .click()
                cy.contains('td', propostaValida.caracterizacao.abrangencia.estado).should('not.exist')
                })
        })
        })
    })
    ...
    context('Dados Pessoais', () => {
        ...
        beforeEach(() => {
        cy.navegarParaProposta('dados-pessoais')
        })

        context('Caminho Feliz', () => {
        it('deve preencher os Dados Pessoais com sucesso', () => {})
        })

        context('Validações', () => {
        it('deve exibir erro quando Nome está vazio', () => {})
        it('deve exibir erro quando Nome excede 64 caracteres', () => {})
        it('deve exibir erro quando Data de Nascimento está vazia', () => {})
        it('deve exibir erro quando Data de Nascimento possui formato inválido', () => {})
        it('deve exibir erro quando País não é selecionado', () => {})
        it('deve exibir erro quando CPF possui dígitos verificadores inválidos', () => {})
        it('deve exibir campo CPF quando País Brasil é selecionado', () => {})
        it('deve exibir campo Nome Social quando checkbox é marcado', () => {})
        })
    })
    ...
    context('Endereço', () => {
        ...
        beforeEach(() => {
        cy.navegarParaProposta('endereco')
        })

        context('Caminho Feliz', () => {
        it('deve preencher o Endereço com autopreenchimento por CEP com sucesso', () => {})
        })

        context('Validações', () => {
        it('deve exibir erro quando CEP está vazio', () => {})
        it('deve exibir erro quando CEP possui formato inválido', () => {})
        it('deve exibir erro quando Número está vazio', () => {})
        it('deve exibir erro quando Número excede 8 caracteres', () => {})
        it('deve exibir erro quando Complemento excede 16 caracteres', () => {})
        })
    })
